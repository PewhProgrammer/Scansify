...
QT_MOC_LITERAL(3, 31, 11), // "updateCloud"
QT_MOC_LITERAL(4, 43, 16), // "PointCloudT::Ptr"
QT_MOC_LITERAL(5, 60, 1), // "c"
QT_MOC_LITERAL(6, 62, 17), // "RGBsliderReleased"
QT_MOC_LITERAL(7, 80, 19), // "pSliderValueChanged"
QT_MOC_LITERAL(8, 100, 5), // "value"
QT_MOC_LITERAL(9, 106, 21), // "redSliderValueChanged"
QT_MOC_LITERAL(10, 128, 23), // "greenSliderValueChanged"
QT_MOC_LITERAL(11, 152, 22) // "blueSliderValueChanged"

    },
    "PCLViewer\0randomButtonPressed\0\0"
    "updateCloud\0PointCloudT::Ptr\0c\0"
...
void PCLViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->updateCloud((*reinterpret_cast< PointCloudT::Ptr(*)>(_a[1]))); break;
