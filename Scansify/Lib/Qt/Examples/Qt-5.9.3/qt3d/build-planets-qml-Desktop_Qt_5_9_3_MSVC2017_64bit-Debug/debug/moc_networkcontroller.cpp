...
#include "../../planets-qml/networkcontroller.h"
...
QT_MOC_LITERAL(1, 18, 15), // "commandAccepted"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 7), // "command"
QT_MOC_LITERAL(4, 43, 5), // "value"
QT_MOC_LITERAL(5, 49, 13), // "newConnection"
QT_MOC_LITERAL(6, 63, 12), // "disconnected"
QT_MOC_LITERAL(7, 76, 9) // "readyRead"

    },
    "NetworkController\0commandAccepted\0\0"
    "command\0value\0newConnection\0disconnected\0"
    "readyRead"
};
...
void NetworkController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->commandAccepted((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        ...
        {
            typedef void (NetworkController::*_t)(QString , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NetworkController::commandAccepted)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject NetworkController::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_NetworkController.data,
      qt_meta_data_NetworkController,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void NetworkController::commandAccepted(QString _t1, QString _t2)
{
