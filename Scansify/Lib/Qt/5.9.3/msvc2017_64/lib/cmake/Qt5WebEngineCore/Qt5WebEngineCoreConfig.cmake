...
set(Qt5WebEngineCore_VERSION_STRING 5.9.3)
...
macro(_populate_WebEngineCore_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set_target_properties(Qt5::WebEngineCore PROPERTIES
        ...
        "IMPORTED_LINK_INTERFACE_LIBRARIES_${Configuration}" "${_Qt5WebEngineCore_LIB_DEPENDENCIES}"
    )
...
if (NOT TARGET Qt5::WebEngineCore)
    ...
    set(Qt5WebEngineCore_PRIVATE_INCLUDE_DIRS
        "${_qt5WebEngineCore_install_prefix}/include/QtWebEngineCore/5.9.3"
        "${_qt5WebEngineCore_install_prefix}/include/QtWebEngineCore/5.9.3/QtWebEngineCore"
    )
    ...
    foreach(_module_dep ${_Qt5WebEngineCore_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.3 ${_Qt5WebEngineCore_FIND_VERSION_EXACT}
    ...
    _populate_WebEngineCore_target_properties(DEBUG "Qt5WebEngineCored.dll" "Qt5WebEngineCored.lib" )
