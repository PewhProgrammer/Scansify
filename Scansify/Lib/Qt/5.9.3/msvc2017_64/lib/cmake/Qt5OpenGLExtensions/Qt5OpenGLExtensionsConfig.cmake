...
set(Qt5OpenGLExtensions_VERSION_STRING 5.9.3)
...
if (NOT TARGET Qt5::OpenGLExtensions)
    ...
    foreach(_module_dep ${_Qt5OpenGLExtensions_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.3 ${_Qt5OpenGLExtensions_FIND_VERSION_EXACT}
    ...
    _populate_OpenGLExtensions_target_properties(RELEASE "Qt5OpenGLExtensions.lib" "" )



    _populate_OpenGLExtensions_target_properties(DEBUG "Qt5OpenGLExtensionsd.lib" "" )
    ...
    macro(_populate_OpenGLExtensions_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5OpenGLExtensions_install_prefix}/plugins/${PLUGIN_LOCATION}")
        _qt5_OpenGLExtensions_check_file_exists(${imported_location})
