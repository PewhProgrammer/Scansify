...
set(Qt5WebEngineWidgets_VERSION_STRING 5.9.3)
...
macro(_populate_WebEngineWidgets_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set_target_properties(Qt5::WebEngineWidgets PROPERTIES
        ...
        "IMPORTED_LINK_INTERFACE_LIBRARIES_${Configuration}" "${_Qt5WebEngineWidgets_LIB_DEPENDENCIES}"
    )
...
if (NOT TARGET Qt5::WebEngineWidgets)
    ...
    set(Qt5WebEngineWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5WebEngineWidgets_install_prefix}/include/QtWebEngineWidgets/5.9.3"
        "${_qt5WebEngineWidgets_install_prefix}/include/QtWebEngineWidgets/5.9.3/QtWebEngineWidgets"
    )
    ...
    foreach(_module_dep ${_Qt5WebEngineWidgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.3 ${_Qt5WebEngineWidgets_FIND_VERSION_EXACT}
    ...
    _populate_WebEngineWidgets_target_properties(DEBUG "Qt5WebEngineWidgetsd.dll" "Qt5WebEngineWidgetsd.lib" )
