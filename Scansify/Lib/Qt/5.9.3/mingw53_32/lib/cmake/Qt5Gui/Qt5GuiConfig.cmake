...
set(Qt5Gui_VERSION_STRING 5.9.3)
...
if (NOT TARGET Qt5::Gui)
    ...
    set(Qt5Gui_PRIVATE_INCLUDE_DIRS
        "${_qt5Gui_install_prefix}/include/QtGui/5.9.3"
        "${_qt5Gui_install_prefix}/include/QtGui/5.9.3/QtGui"
    )
    ...
    foreach(_module_dep ${_Qt5Gui_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.3 ${_Qt5Gui_FIND_VERSION_EXACT}
    ...
    _populate_Gui_target_properties(RELEASE "Qt5Gui.dll" "libQt5Gui.a" )
