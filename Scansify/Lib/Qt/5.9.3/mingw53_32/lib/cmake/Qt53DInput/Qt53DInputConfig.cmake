...
set(Qt53DInput_VERSION_STRING 5.9.3)
...
if (NOT TARGET Qt5::3DInput)
    ...
    set(Qt53DInput_PRIVATE_INCLUDE_DIRS
        "${_qt53DInput_install_prefix}/include/Qt3DInput/5.9.3"
        "${_qt53DInput_install_prefix}/include/Qt3DInput/5.9.3/Qt3DInput"
    )
    ...
    foreach(_module_dep ${_Qt53DInput_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.3 ${_Qt53DInput_FIND_VERSION_EXACT}
    ...
    _populate_3DInput_target_properties(RELEASE "Qt53DInput.dll" "libQt53DInput.a" )



    _populate_3DInput_target_properties(DEBUG "Qt53DInputd.dll" "libQt53DInputd.a" )
