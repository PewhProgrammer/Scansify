...
set(Qt5MultimediaWidgets_VERSION_STRING 5.9.3)
...
macro(_populate_MultimediaWidgets_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5MultimediaWidgets_install_prefix}/bin/${LIB_LOCATION}")
    ...
    set(imported_implib "${_qt5MultimediaWidgets_install_prefix}/lib/${IMPLIB_LOCATION}")
    _qt5_MultimediaWidgets_check_file_exists(${imported_implib})
...
if (NOT TARGET Qt5::MultimediaWidgets)
    ...
    set(Qt5MultimediaWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5MultimediaWidgets_install_prefix}/include/QtMultimediaWidgets/5.9.3"
        "${_qt5MultimediaWidgets_install_prefix}/include/QtMultimediaWidgets/5.9.3/QtMultimediaWidgets"
    )
    ...
    foreach(_module_dep ${_Qt5MultimediaWidgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.3 ${_Qt5MultimediaWidgets_FIND_VERSION_EXACT}
    ...
    _populate_MultimediaWidgets_target_properties(RELEASE "Qt5MultimediaWidgets.dll" "libQt5MultimediaWidgets.a" )



    _populate_MultimediaWidgets_target_properties(DEBUG "Qt5MultimediaWidgetsd.dll" "libQt5MultimediaWidgetsd.a" )
