...
set(Qt5DBus_VERSION_STRING 5.9.3)
...
macro(_populate_DBus_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5DBus_install_prefix}/bin/${LIB_LOCATION}")
    ...
    set(imported_implib "${_qt5DBus_install_prefix}/lib/${IMPLIB_LOCATION}")
    _qt5_DBus_check_file_exists(${imported_implib})
...
if (NOT TARGET Qt5::DBus)
    ...
    set(Qt5DBus_PRIVATE_INCLUDE_DIRS
        "${_qt5DBus_install_prefix}/include/QtDBus/5.9.3"
        "${_qt5DBus_install_prefix}/include/QtDBus/5.9.3/QtDBus"
    )
    ...
    foreach(_module_dep ${_Qt5DBus_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.3 ${_Qt5DBus_FIND_VERSION_EXACT}
    ...
    _populate_DBus_target_properties(RELEASE "Qt5DBus.dll" "libQt5DBus.a" )
