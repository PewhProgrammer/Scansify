...
set(Qt5Test_VERSION_STRING 5.9.3)
...
macro(_populate_Test_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Test_install_prefix}/bin/${LIB_LOCATION}")
    _qt5_Test_check_file_exists(${imported_location})
    set_target_properties(Qt5::Test PROPERTIES
        "INTERFACE_LINK_LIBRARIES" "${_Qt5Test_LIB_DEPENDENCIES}"
...
if (NOT TARGET Qt5::Test)
    ...
    set(Qt5Test_PRIVATE_INCLUDE_DIRS
        "${_qt5Test_install_prefix}/include/QtTest/5.9.3"
        "${_qt5Test_install_prefix}/include/QtTest/5.9.3/QtTest"
    )
    ...
    foreach(_module_dep ${_Qt5Test_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.3 ${_Qt5Test_FIND_VERSION_EXACT}
    ...
    _populate_Test_target_properties(RELEASE "Qt5Test.dll" "libQt5Test.a" )
