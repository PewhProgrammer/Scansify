...
set(Qt5SerialBus_VERSION_STRING 5.9.3)
...
macro(_populate_SerialBus_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5SerialBus_install_prefix}/bin/${LIB_LOCATION}")
    _qt5_SerialBus_check_file_exists(${imported_location})
    set_target_properties(Qt5::SerialBus PROPERTIES
        "INTERFACE_LINK_LIBRARIES" "${_Qt5SerialBus_LIB_DEPENDENCIES}"
        "IMPORTED_LOCATION_${Configuration}" ${imported_location}
        # For backward compatibility with CMake < 2.8.12
        "IMPORTED_LINK_INTERFACE_LIBRARIES_${Configuration}" "${_Qt5SerialBus_LIB_DEPENDENCIES}"
    )

    set(imported_implib "${_qt5SerialBus_install_prefix}/lib/${IMPLIB_LOCATION}")
    _qt5_SerialBus_check_file_exists(${imported_implib})
...
if (NOT TARGET Qt5::SerialBus)
    ...
    set(Qt5SerialBus_PRIVATE_INCLUDE_DIRS
        "${_qt5SerialBus_install_prefix}/include/QtSerialBus/5.9.3"
        "${_qt5SerialBus_install_prefix}/include/QtSerialBus/5.9.3/QtSerialBus"
    )
    ...
    foreach(_module_dep ${_Qt5SerialBus_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.3 ${_Qt5SerialBus_FIND_VERSION_EXACT}
    ...
    _populate_SerialBus_target_properties(RELEASE "Qt5SerialBus.dll" "libQt5SerialBus.a" )



    _populate_SerialBus_target_properties(DEBUG "Qt5SerialBusd.dll" "libQt5SerialBusd.a" )
