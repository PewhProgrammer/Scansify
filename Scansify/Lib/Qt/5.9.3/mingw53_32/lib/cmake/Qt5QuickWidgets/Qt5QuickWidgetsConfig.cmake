...
set(Qt5QuickWidgets_VERSION_STRING 5.9.3)
...
if (NOT TARGET Qt5::QuickWidgets)
    ...
    set(Qt5QuickWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickWidgets_install_prefix}/include/QtQuickWidgets/5.9.3"
        "${_qt5QuickWidgets_install_prefix}/include/QtQuickWidgets/5.9.3/QtQuickWidgets"
    )
    ...
    foreach(_module_dep ${_Qt5QuickWidgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.3 ${_Qt5QuickWidgets_FIND_VERSION_EXACT}
    ...
    _populate_QuickWidgets_target_properties(RELEASE "Qt5QuickWidgets.dll" "libQt5QuickWidgets.a" )



    _populate_QuickWidgets_target_properties(DEBUG "Qt5QuickWidgetsd.dll" "libQt5QuickWidgetsd.a" )
