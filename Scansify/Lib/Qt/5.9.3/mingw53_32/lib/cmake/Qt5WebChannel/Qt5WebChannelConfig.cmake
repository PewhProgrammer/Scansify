...
set(Qt5WebChannel_VERSION_STRING 5.9.3)
...
macro(_populate_WebChannel_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set_target_properties(Qt5::WebChannel PROPERTIES
        "INTERFACE_LINK_LIBRARIES" "${_Qt5WebChannel_LIB_DEPENDENCIES}"
        "IMPORTED_LOCATION_${Configuration}" ${imported_location}
        # For backward compatibility with CMake < 2.8.12
        "IMPORTED_LINK_INTERFACE_LIBRARIES_${Configuration}" "${_Qt5WebChannel_LIB_DEPENDENCIES}"
    )
...
if (NOT TARGET Qt5::WebChannel)
    ...
    set(Qt5WebChannel_PRIVATE_INCLUDE_DIRS
        "${_qt5WebChannel_install_prefix}/include/QtWebChannel/5.9.3"
        "${_qt5WebChannel_install_prefix}/include/QtWebChannel/5.9.3/QtWebChannel"
    )
    ...
    foreach(_module_dep ${_Qt5WebChannel_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.3 ${_Qt5WebChannel_FIND_VERSION_EXACT}
    ...
    _populate_WebChannel_target_properties(RELEASE "Qt5WebChannel.dll" "libQt5WebChannel.a" )
