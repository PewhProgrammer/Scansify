...
set(Qt53DCore_VERSION_STRING 5.9.3)
...
if (NOT TARGET Qt5::3DCore)
    ...
    set(Qt53DCore_PRIVATE_INCLUDE_DIRS
        "${_qt53DCore_install_prefix}/include/Qt3DCore/5.9.3"
        "${_qt53DCore_install_prefix}/include/Qt3DCore/5.9.3/Qt3DCore"
    )
    ...
    foreach(_module_dep ${_Qt53DCore_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.3 ${_Qt53DCore_FIND_VERSION_EXACT}
    ...
    _populate_3DCore_target_properties(RELEASE "Qt53DCore.dll" "libQt53DCore.a" )



    _populate_3DCore_target_properties(DEBUG "Qt53DCored.dll" "libQt53DCored.a" )
