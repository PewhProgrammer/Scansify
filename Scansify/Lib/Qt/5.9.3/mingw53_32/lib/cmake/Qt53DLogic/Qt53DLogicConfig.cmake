...
set(Qt53DLogic_VERSION_STRING 5.9.3)
...
if (NOT TARGET Qt5::3DLogic)
    ...
    set(Qt53DLogic_PRIVATE_INCLUDE_DIRS
        "${_qt53DLogic_install_prefix}/include/Qt3DLogic/5.9.3"
        "${_qt53DLogic_install_prefix}/include/Qt3DLogic/5.9.3/Qt3DLogic"
    )
    ...
    foreach(_module_dep ${_Qt53DLogic_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.3 ${_Qt53DLogic_FIND_VERSION_EXACT}
    ...
    _populate_3DLogic_target_properties(RELEASE "Qt53DLogic.dll" "libQt53DLogic.a" )



    _populate_3DLogic_target_properties(DEBUG "Qt53DLogicd.dll" "libQt53DLogicd.a" )
