...
set(Qt5QuickTest_VERSION_STRING 5.9.3)
...
macro(_populate_QuickTest_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5QuickTest_install_prefix}/bin/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::QuickTest)
    ...
    set(Qt5QuickTest_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickTest_install_prefix}/include/QtQuickTest/5.9.3"
        "${_qt5QuickTest_install_prefix}/include/QtQuickTest/5.9.3/QtQuickTest"
    )
    ...
    foreach(_module_dep ${_Qt5QuickTest_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.3 ${_Qt5QuickTest_FIND_VERSION_EXACT}
    ...
    _populate_QuickTest_target_properties(RELEASE "Qt5QuickTest.dll" "libQt5QuickTest.a" )



    _populate_QuickTest_target_properties(DEBUG "Qt5QuickTestd.dll" "libQt5QuickTestd.a" )
