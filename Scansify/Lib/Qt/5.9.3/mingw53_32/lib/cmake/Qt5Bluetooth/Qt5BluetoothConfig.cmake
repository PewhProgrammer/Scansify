...
set(Qt5Bluetooth_VERSION_STRING 5.9.3)
...
macro(_populate_Bluetooth_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Bluetooth_install_prefix}/bin/${LIB_LOCATION}")
    ...
    set(imported_implib "${_qt5Bluetooth_install_prefix}/lib/${IMPLIB_LOCATION}")
    _qt5_Bluetooth_check_file_exists(${imported_implib})
...
if (NOT TARGET Qt5::Bluetooth)
    ...
    set(Qt5Bluetooth_PRIVATE_INCLUDE_DIRS
        "${_qt5Bluetooth_install_prefix}/include/QtBluetooth/5.9.3"
        "${_qt5Bluetooth_install_prefix}/include/QtBluetooth/5.9.3/QtBluetooth"
    )
    ...
    foreach(_module_dep ${_Qt5Bluetooth_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.3 ${_Qt5Bluetooth_FIND_VERSION_EXACT}
    ...
    _populate_Bluetooth_target_properties(RELEASE "Qt5Bluetooth.dll" "libQt5Bluetooth.a" )
