...
set(Qt5Scxml_VERSION_STRING 5.9.3)
...
macro(_populate_Scxml_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Scxml_install_prefix}/bin/${LIB_LOCATION}")
    _qt5_Scxml_check_file_exists(${imported_location})
    set_target_properties(Qt5::Scxml PROPERTIES
        "INTERFACE_LINK_LIBRARIES" "${_Qt5Scxml_LIB_DEPENDENCIES}"
        "IMPORTED_LOCATION_${Configuration}" ${imported_location}
        # For backward compatibility with CMake < 2.8.12
        "IMPORTED_LINK_INTERFACE_LIBRARIES_${Configuration}" "${_Qt5Scxml_LIB_DEPENDENCIES}"
    )

    set(imported_implib "${_qt5Scxml_install_prefix}/lib/${IMPLIB_LOCATION}")
    _qt5_Scxml_check_file_exists(${imported_implib})
...
if (NOT TARGET Qt5::Scxml)
    ...
    set(Qt5Scxml_PRIVATE_INCLUDE_DIRS
        "${_qt5Scxml_install_prefix}/include/QtScxml/5.9.3"
        "${_qt5Scxml_install_prefix}/include/QtScxml/5.9.3/QtScxml"
    )
    ...
    foreach(_module_dep ${_Qt5Scxml_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.3 ${_Qt5Scxml_FIND_VERSION_EXACT}
    ...
    _populate_Scxml_target_properties(RELEASE "Qt5Scxml.dll" "libQt5Scxml.a" )



    _populate_Scxml_target_properties(DEBUG "Qt5Scxmld.dll" "libQt5Scxmld.a" )
